...
var (
	...
	subsystemCmd    = &cobra.Command{
		Use:   "startsubsys",
		Short: "Use zfileshare as SFTP file transfer subsystem",
		Long:  ``,
		Run: func(_ *cobra.Command, _ []string) {
			...
			logger.Info(logSender, connectionID, "starting zfileshare %v as subsystem, "+
				"user %q home dir %q config dir %q base home dir %q",
